...
function MsgTime() {
  ...
  return (
    <span
      ...
      style={{ fontSize: "10px", color: "var(--text-muted)", letterSpacing: "0.06em" }}
    >
      {t}
    </span>
  );
  ...
  return (
    ...
    >
      ...
      {isUser ? (
        ...
        >
          <User size={13} style={{ color: "var(--mcp-crm)" }} />
        </div>
      ) : (
        <div
        ...
        >
            ...
            <span className="inline-flex gap-1.5 items-center">
              {[0, 150, 300].map((delay) => (
                <span
                  ...
                  style={{ background: "var(--chat-dot)", animationDelay: `${delay}ms` }}
                />
              ))}
            </span>
          )}
          ...
          {message.isStreaming && message.content && (
            <span
              ...
              style={{ background: "var(--accent-red)", boxShadow: "0 0 6px var(--accent-glow)" }}
            />
          )}
        </div>
